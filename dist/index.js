...
var SECRET = "foijdmgikjmnsdghgmnikjjankdhgi";
var SECRET2 = "FAFDFJOIGJG515415454";
...
_models2.default.sequelize.sync({}).then(function () {
  server.listen(8081, function () {
    ...
    new _subscriptionsTransportWs.SubscriptionServer({
      ...
      schema: schema,
      onConnect: function () {
        var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(connectionParams, webSocket) {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.prev = 1;
                  _jwt$verify2 = _jsonwebtoken2.default.verify(connectionParams.token, SECRET), user = _jwt$verify2.user;
                ...
                case 6:
                  ...
                  _context2.next = 10;
                  return (0, _auth.refreshTokens)(connectionParams.token, connectionParams.refreshToken, _models2.default, SECRET, SECRET2);
